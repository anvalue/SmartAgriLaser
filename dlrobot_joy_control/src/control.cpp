...
dlrobot_joy::dlrobot_joy() 
{
   ...
   sub = n.subscribe<sensor_msgs::Joy>("joy",10,&dlrobot_joy::callback,this); //订阅手柄发来的数据
} 

void dlrobot_joy::callback(const sensor_msgs::Joy::ConstPtr& Joy) //键值回调函数
 {
