...
void voice_choose_callback(const std_msgs::String& msg)
{
	...
	if(str1 == str2)
	{
		...
		system("aplay -D plughw:CARD=Device,DEV=0 ~/dlrobot_robot/src/xf_mic_asr_offline/feedback_voice/rplidar_close.wav");
		cout<<"已关闭雷达跟随"<<endl;
	}
	...
	else if(str1 == str3)
	{
		...
		system("aplay -D plughw:CARD=Device,DEV=0 ~/dlrobot_robot/src/xf_mic_asr_offline/feedback_voice/visual_close.wav");
		cout<<"已关闭视觉跟随"<<endl;
	}
	...
	else if(str1 == str4)
	{
		...
		system("aplay -D plughw:CARD=Device,DEV=0 ~/dlrobot_robot/src/xf_mic_asr_offline/feedback_voice/rrt_close.wav");
	...
	else if(str1 == str5)
	{
		...
		cmd_vel_msg.angular.z = 0;
		cmdvel_pub.publish(cmd_vel_msg);
		system("aplay -D plughw:CARD=Device,DEV=0 ~/dlrobot_robot/src/xf_mic_asr_offline/feedback_voice/navigation_close.wav");
		cout<<"已关闭多点导航"<<endl;
	}
...
void laser_follow_flagCallback(std_msgs::Int8 msg)
{
	...
	{
		system("aplay -D plughw:CARD=Device,DEV=0 ~/dlrobot_robot/src/xf_mic_asr_offline/feedback_voice/rplidar_open.wav");
...
void rrt_flagCallback(std_msgs::Int8 msg)
{
	...
	if(rrt_flag == 1)
	{
		system("aplay -D plughw:CARD=Device,DEV=0 ~/dlrobot_robot/src/xf_mic_asr_offline/feedback_voice/rrt_open.wav");
		cout<<"自主建图打开成功"<<endl;
	}
...
void visual_follow_flagCallback(std_msgs::Int8 msg)
{
	...
	{
		system("aplay -D plughw:CARD=Device,DEV=0 ~/dlrobot_robot/src/xf_mic_asr_offline/feedback_voice/visual_open.wav");
		cout<<"视觉跟随打开成功"<<endl;
