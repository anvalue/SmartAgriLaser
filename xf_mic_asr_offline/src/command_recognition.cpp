...
***********************************/
    ...
    system("aplay -D plughw:CARD=Device,DEV=0 ~/dlrobot_robot/src/xf_mic_asr_offline/feedback_voice/car_front.wav");//语音反馈
		cout<<"好的：小车前进"<<endl;
	}
/***********************************
指令：小车后退
...
***********************************/
	else if(str1 == str3)
	{
        ...
        cmd_vel_flag_msg.data = 1;
        cmd_vel_flag_pub.publish(cmd_vel_flag_msg);
        system("aplay -D plughw:CARD=Device,DEV=0 ~/dlrobot_robot/src/xf_mic_asr_offline/feedback_voice/car_back.wav");
		cout<<"好的：小车后退"<<endl;
	}
/***********************************
指令：小车左转
...
***********************************/
	else if(str1 == str4)
	{
        ...
        cmd_vel_flag_msg.data = 1;
        cmd_vel_flag_pub.publish(cmd_vel_flag_msg);
        system("aplay -D plughw:CARD=Device,DEV=0 ~/dlrobot_robot/src/xf_mic_asr_offline/feedback_voice/turn_left.wav");
		cout<<"好的：小车左转"<<endl;
	}
/***********************************
指令：小车右转
...
***********************************/
	else if(str1 == str5)
	{
        ...
        cmd_vel_flag_msg.data = 1;
        cmd_vel_flag_pub.publish(cmd_vel_flag_msg);
        system("aplay -D plughw:CARD=Device,DEV=0 ~/dlrobot_robot/src/xf_mic_asr_offline/feedback_voice/turn_right.wav");
		cout<<"好的：小车右转"<<endl;
	}
/***********************************
指令：小车停
...
***********************************/
	else if(str1 == str6)
	{
        ...
        cmd_vel_flag_msg.data = 1;
        cmd_vel_flag_pub.publish(cmd_vel_flag_msg);
        system("aplay -D plughw:CARD=Device,DEV=0 ~/dlrobot_robot/src/xf_mic_asr_offline/feedback_voice/stop.wav");
		cout<<"好的：小车停"<<endl;
	}
/***********************************
指令：小车休眠
...
***********************************/
	else if(str1 == str7)
	{
        ...
        cmd_vel_flag_msg.data = 1;
        cmd_vel_flag_pub.publish(cmd_vel_flag_msg);
        system("aplay -D plughw:CARD=Device,DEV=0 ~/dlrobot_robot/src/xf_mic_asr_offline/feedback_voice/sleep.wav");
...
***********************************/
	else if(str1 == str8)
	{
		...
		system("aplay -D plughw:CARD=Device,DEV=0 ~/dlrobot_robot/src/xf_mic_asr_offline/feedback_voice/search_voice.wav");
		cout<<"好的：小车寻找声源"<<endl;
	}
/***********************************
指令：小车去I点
...
***********************************/
	else if(str1 == str9)
	{
        ...
        system("aplay -D plughw:CARD=Device,DEV=0 ~/dlrobot_robot/src/xf_mic_asr_offline/feedback_voice/OK.wav");
...
***********************************/
	...
	{
		system("aplay -D plughw:CARD=Device,DEV=0 ~/dlrobot_robot/src/xf_mic_asr_offline/feedback_voice/Tracker.wav");
...
***********************************/
	else if(str1 == str15)
	{
		...
		system("aplay -D plughw:CARD=Device,DEV=0 ~/dlrobot_robot/src/xf_mic_asr_offline/feedback_voice/awake.wav");
	...
	{
		sw = "off";
		system("aplay -D plughw:CARD=Device,DEV=0 ~/dlrobot_robot/src/xf_mic_asr_offline/feedback_voice/OK.wav");//用扬声器播报:好的
...
void voice_flag_Callback(std_msgs::Int8 msg)
{
	...
	if(voice_flag == 1)
	{
		system("aplay -D plughw:CARD=Device,DEV=0 ~/dlrobot_robot/src/xf_mic_asr_offline/feedback_voice/voice_control.wav");
		cout<<"语音打开成功"<<endl;
	}
...
int main(int argc, char** argv)
{
 ...
 //         system("dbus-launch gnome-terminal -- roslaunch dlrobot_arm_six voi_demo.launch");
 //         sleep(3);
