...
from dlrobot_nav.cfg import CalibrateLinearConfig
import tf
...
class CalibrateLinear():
    def __init__(self):
        ...
        #self.tf_listener.waitForTransform("odom_combined", "base_link", rospy.Time(), rospy.Duration(60.0))   
        rospy.loginfo("6")   
        ...
        while not rospy.is_shutdown():
            ...
            if self.start_test:
                ...
                self.position = self.get_position()
                rospy.loginfo("self.position.x =%f, self.position.y=%f",self.position.x,self.position.y)
