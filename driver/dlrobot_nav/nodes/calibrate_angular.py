...
from dlrobot_nav.cfg import CalibrateAngularConfig
import tf
from math import radians, copysign
from dlrobot_nav.transform_utils import quat_to_angle, normalize_angle
        ...
        while not rospy.is_shutdown():
            if self.start_test:
                ...
                while abs(error) > self.tolerance and self.start_test:
                    ...
                    rospy.loginfo("turn_angle =%f, test_angle=%f",turn_angle,self.test_angle)
                ...
                rospy.loginfo("angle =%f",self.get_odom_angle())
